    ...
    if(isset($_POST['update'] ) ) {
        ...
        if(! array_filter($errors) ) {
            ...
            $sql = "UPDATE stock_item
                    SET stock_sku = '$stock_sku', stock_name = '$stock_name', stock_unit = '$stock_unit', stock_desc = '$stock_desc', stock_qty = '$stock_qty', unit_cost = '$unit_cost', total_cost = '$total_cost'
                    WHERE stock_id = $id_to_update";
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Stock Item</h6>
                        </div>
                        <div class="card-body">
                            <?php if($stock_item): ?>
                                <form class="needs-validation" action="edit-stock-item.php" method="POST">

                                    <div class="mb-3">
                                        <label for="inputStockSKU" class="form-label">Stock SKU *</label>
                                        <input type="text" class="form-control" name="stock-sku" id="stock-sku" value="<?php echo htmlspecialchars($stock_item['stock_sku']) ?>">
                                        <div class="mt-2 text-danger"> <?php echo $errors['stock-sku'] ?></div>
                                    </div>

                                    <div class="mb-3">
                                        <label for="inputStockName" class="form-label">Stock Name *</label>
                                        <input type="text" class="form-control" name="stock-name" id="stock-name" value="<?php echo htmlspecialchars($stock_item['stock_name']) ?>">
                                        <div class="mt-2 text-danger"> <?php echo $errors['stock-name'] ?></div>
                                    </div>

                                    <div class="mb-3">
                                        <label for="inputStockUnit" class="form-label">Stock Unit *</label>
                                        <input type="text" class="form-control" name="stock-unit" id="stock-unit" value="<?php echo htmlspecialchars($stock_item['stock_unit']) ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="stock-desc" id="stock-desc" value="<?php echo htmlspecialchars($stock_item['stock_desc']) ?>">
                                        <div class="mt-2 text-danger"> <?php echo $errors['stock-desc'] ?></div>
                                    </div>

                                    <div class="mb-3">
                                        <label for="inputStockQty" class="form-label">Stock Quantity *</label>
                                        <input type="text" class="form-control" name="stock-qty" id="stock-qty" value="<?php echo htmlspecialchars($stock_item['stock_qty']) ?>">
                                        <div class="mt-2 text-danger"> <?php echo $errors['stock-qty'] ?></div>
                                    </div>

                                    <div class="mb-3">
                                        <label for="inputUnitCost" class="form-label">Stock Unit Cost *</label>
                                        <input type="text" class="form-control" name="unit-cost" id="unit-cost" value="<?php echo htmlspecialchars($stock_item['unit_cost']) ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <form action="edit-stock-item.php" method="POST" class="mr-1">
                                            <input type="hidden" name="id_to_update" value="<?php echo $stock_item['stock_id'] ?>">
